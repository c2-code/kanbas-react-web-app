      ...
      <div key={assignment._id}>
        ...
        <div className="row mb-3">
          <div className="col-md-4 text-md-end d-flex align-items-center">
            <label htmlFor="wd-points" className="fw-bold">
              Points
            </label>
          </div>
        ...
        <div className="row mb-3">
          <div className="col-md-4 text-md-end d-flex align-items-center">
            <label htmlFor="wd-group" className="fw-bold">
              Assignment Group
            </label>
          </div>
          <div className="col-md-8">
        ...
        <div className="row mb-3">
          <div className="col-md-4 text-md-end d-flex align-items-center">
            <label htmlFor="wd-display-grade-as" className="fw-bold">
              Display Grade as
            </label>
          </div>
          <div className="col-md-8">
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-8">
            <div className="border p-3 rounded">
              <div className="mb-3">
                <label htmlFor="wd-submission-type" className="me-2">
                  Submission Type
                </label>
                <select
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-8">
            <div className="border p-3 rounded">
              <div className="mb-3">
                <label htmlFor="wd-assign-to" className="me-2">
                  Assign to
                </label>
                <input
                  id="wd-assign-to"
              ...
              <div className="mb-3">
                <label htmlFor="wd-due-date" className="me-2">
                  Due
                </label>
