...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <h3>Updating an Item in an Array - update todo title</h3>
      ...
      <br /><br />
      <hr />
    {/** Add a text input field to edit the description and a checkbox input field to edit the completed property */}
    <h3>Updating an Item in an Array - edit description</h3>
    ...
    <br /><br />
    <h3>Updating an Item in an Array - edit completed with checkbox input field</h3>
    <a href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end">
      Update completed
    </a>
    <input defaultValue={todo.id} className="form-control w-25 float-start me-2"
      onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
    <div className="form-check form-switch w-50 float-start">
